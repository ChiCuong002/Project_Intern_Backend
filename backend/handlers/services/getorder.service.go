...
// func PurchaseProduct(c *schema.Product, db *gorm.DB,ct echo.Context, userID, productID, quantity uint) (error) {
// 	var user schema.User
//     var product schema.Product

//     // Truy xuất thông tin người dùng và sản phẩm từ cơ sở dữ liệu
//     var user User
//     var product Product
